...
export default class NoticeIcon extends PureComponent {
  ...
  viewNotice = e => {
    ...
    if (this.props.count == undefined) {
      ...
      let { dispatch } = store;
      // dispatch(routerRedux.push('/manage/manage-message?result=1'));
      window.location = window.location.origin + '/manage/manage-message?result=1';
    }
  };
  ...
  render() {
    ...
    const trigger = (
      <span className={noticeButtonClass}>
        <Badge count={count} className={styles.badge} onClick={this.viewNotice}>
